...
import dev.joxit.androidapp.audiorecorder.activity.recorder.state.RecorderState
...
class RecorderViewModel(application: Application) : AndroidViewModel(application) {
  ...
  val recorderState: MutableLiveData<RecorderState> = MutableLiveData(RecorderState.STOPPED)
