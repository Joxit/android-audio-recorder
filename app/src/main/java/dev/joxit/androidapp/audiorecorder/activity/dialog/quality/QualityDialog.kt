package dev.joxit.androidapp.audiorecorder.activity.dialog.quality
...
class QualityDialog: DialogFragment() {
    ...
    return AlertDialog.Builder(activity)
      .setCustomTitle(
        DialogFactory.createTitleView(
          ...
          R.string.AURE_SETTINGS_TITLE_AUDIO_QUALITY
        )
      )
      .setView(buildView())
      .create()
  ...
  private fun buildView() : View {
    ...
    val adapter = QualityAdapter(requireActivity(), list, 0)
    list.choiceMode = 1
